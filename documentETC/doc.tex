...
methods of timekeeping aren\textquotesingle t always necessary, we still seek even more
...
following this idea already exist, most are overly complicated, look chintzy, or are
...
with indididually programmable lights to power the face of the clock. For the
...
will develop a software library to run on the microcontroller that supports the
various modes of displaying time as well as to provide any additional functionality
