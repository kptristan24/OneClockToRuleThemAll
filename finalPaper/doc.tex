...
\begin{itemize}
	\item Lines 1 through 7 are the hardware abstractions and global flags
	\item Lines 9 through 20 are run once setup functions
	\item \textbf{Note:} 15 is where the starting program for the clock is selected
