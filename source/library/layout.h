...
const int fiveM[6] PROGMEM= {6,0,0,0,0,0};

const int tenM[6] PROGMEM= {6,0,0,0,0,0};

const int fifteenM[6] PROGMEM= {6,0,0,0,0,0};

const int twentyM[6] PROGMEM= {6,0,0,0,0,0};

const int twentyfiveM[6] PROGMEM= {6,0,0,0,0,0};

const int thirtyM[6] PROGMEM= {6,0,0,0,0,0};

const int thirtyfiveM[6] PROGMEM= {6,0,0,0,0,0};

const int fourtyM[6] PROGMEM= {6,0,0,0,0,0};

const int fourtyfiveM[6] PROGMEM= {6,0,0,0,0,0};

const int fiftyM[6] PROGMEM= {6,0,0,0,0,0};

const int fiftyfiveM[6] PROGMEM= {6,0,0,0,0,0};


//******* Hour word positions *******//
const int one[4] PROGMEM= {4,0,0,0};

const int two[4] PROGMEM= {4,0,0,0};

const int three[6] PROGMEM= {6,0,0,0,0,0};

const int four[5] PROGMEM= {5,0,0,0,0};

const int five[5] PROGMEM= {5,0,0,0,0};

const int six[4] PROGMEM= {4,0,0,0};

const int seven[6] PROGMEM= {6,0,0,0,0,0};

const int eight[6] PROGMEM= {6,0,0,0,0,0};

const int nine[5] PROGMEM= {5,0,0,0,0};

const int ten[4] PROGMEM= {4,0,0,0};

const int eleven[7] PROGMEM= {7,0,0,0,0,0,0};

const int twelve[7] PROGMEM= {7,0,0,0,0,0,0};
...
const int extra[6] PROGMEM= {1,1,1,1,1,1};

//does the grid contain am/pm?
const int amE[3] PROGMEM= {3, 0 , 0};

const int pmE[3] PROGMEM= {3, 0 , 0};

//are their words/symbols for minute incrememnts?
const int minOne[2] PROGMEM= {2, 0};

const int minTwo[2] PROGMEM= {2, 0};

const int minThree[2] PROGMEM= {2, 0};

const int minFour[2] PROGMEM= {2, 0};
