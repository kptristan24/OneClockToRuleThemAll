...
We will review the technical details of why our preffered techonology is chosen, and what benefits and disadvantages come along with it.
In the end this assignment was able to help the group solidfy and reconsider some of the choices we had in mind.
...
The raspberry pi is also an excellent product. There and thousandds of project examples that are out there for the pi as is.
